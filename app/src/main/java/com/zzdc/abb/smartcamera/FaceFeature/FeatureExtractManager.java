...
public class FeatureExtractManager {
    ...
    private static AFD_FSDKEngine getAFD_FSDKEngine() {
        ...
        AFD_FSDKError err = FSDKEngine.AFD_FSDK_InitialFaceEngine(FaceConfig.faceAPP_Id,
                FaceConfig.faceFD_Key, AFD_FSDKEngine.AFD_OPF_0_HIGHER_EXT, FaceConfig.scale, FaceConfig.maxFacesNUM);
        if (err.getCode() == 0) {
            return FSDKEngine;
        } else {
